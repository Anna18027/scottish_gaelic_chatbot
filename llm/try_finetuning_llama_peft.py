...
#track percentage of trainable parameters
def get_trainable_percentage(model):
    total_params = 0
    trainable_params = 0
...
#     # Unfreeze last few transformer layers (e.g. last 2)
...
trainable_percent = get_trainable_percentage(model)
print(f"Trainable parameters: {trainable_percent:.2f}%")
wandb.log({"trainable_percent": trainable_percent})
...
wandb.log({"total_runtime_seconds": total_runtime})
