...
# train_file_big = "/disk/scratch_big/s2751141/data/madlad_from_huggingface/gd_clean_0000.jsonl.gz"
# val_file = "/disk/scratch/s2751141/data/temp_data/gaidhlig_test_set.txt"
train_file = "/home/s2751141/dissertation/scottish_gaelic_chatbot/data/madlad_from_huggingface/gd_clean_0000.jsonl.gz"
val_file = "/home/s2751141/dissertation/scottish_gaelic_chatbot/data/temp_data/gaidhlig_test_set.txt"
...
output_dir = "/home/s2751141/dissertation/scottish_gaelic_chatbot/model_results/llama_finetuned"
...
model_path = "/home/s2751141/dissertation/scottish_gaelic_chatbot/hf_models/models--meta-llama--Llama-3.2-1B"
...
# train_file = os.path.join(os.environ["SCRATCH"], "data/madlad_from_huggingface/gd_clean_0000.jsonl.gz")
dataset = load_dataset("json", data_files={"train": train_file}, split="train")

# print("Checking if train file exists:", os.path.exists(train_file))
# print("Resolved path:", os.path.realpath(train_file))
...
# try:
#     dataset = load_dataset("json", data_files={"train": train_file}, split="train")
#     print(f"✅ Loaded dataset from train_file: {train_file}")
# except Exception as e1:
#     print(f"⚠️ Failed to load train_file: {train_file}")
#     print(f"Error: {e1}")
#     try:
#         dataset = load_dataset("json", data_files={"train": train_file_big}, split="train")
#         print(f"✅ Loaded dataset from train_file_big: {train_file_big}")
#     except Exception as e2:
#         print(f"❌ Failed to load both train_file and train_file_big.")
